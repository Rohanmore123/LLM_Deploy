...
class VectorSearchWithBedrock():
    ...
    def __init__(self, index_store="./index/faiss_index"):
        ...
        self.embeddings = BedrockEmbeddings(
            client=self.bedrock_client, region_name="ap-south-1")
    ...
    def _get_bedrock_client(self, assume_role, profile_name='default', runtime=True):
        ...
        response = sts.assume_role(
            RoleArn=str("arn:aws:iam::471112983796:role/EC2_full_Access"),
    ...
    def load_vector(self,index):
        ...
        """
        faiss_vectorstore = FAISS.load_local(index, self.embeddings)
